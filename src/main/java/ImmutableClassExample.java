...
/*To create an immutable class in java, you have to do following steps.
        ...
        Make all mutable fields final so that it’defaultInterfaceMethod1 value can be assigned only once.
        Initialize all the fields via defaultInterfaceMethod2 constructor performing deep copy.
        Perform cloning of objects in the getter methods to return defaultInterfaceMethod2 copy rather than returning the actual object reference.
        */
